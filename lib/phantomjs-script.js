    ...
    page.paperSize = {
        ...
        header : {
            ...
            contents : phantom.callback(function (pageNum, numPages) {
                 ...
                 */
                var out = '<div class="hd-generated" style="width: ' + VIEWPORT_WIDTH + 'px;">' + globalHeader.content + '</div>';
                return out;
            })
        },
        footer : {
            ...
            contents : phantom.callback(function (pageNum, numPages) {
                 ...
                 */
                var out = '<div class="ft-generated" style="width: ' + VIEWPORT_WIDTH + 'px;">' + globalFooter.content + '</div>';
                return out;
            })
        }
    };
